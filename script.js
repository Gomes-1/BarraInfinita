...
function calcularE() {
  ...
  const formula = `\\[E = \\frac{2 \\cdot k \\cdot \\lambda}{y} \\cdot \\frac{L}{\\sqrt{4y^2 + L^2}}\\]` +
                  `\\[k = \\frac{1}{4 \\pi \\varepsilon_0}\\]` +
                  `\\[E = \\frac{2 \\cdot ${k.toFixed(5)} \\cdot ${lambda}}{${y}} \\cdot \\frac{${L}}{\\sqrt{4 \\cdot ${y}^2 + ${L}^2}} = ${E.toFixed(5)}\\]`;
